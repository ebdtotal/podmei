...
> = {
  ...
  contador_premium: {
    ...
    who: "Para o escritório no Simples Nacional — com cobrança automática por e-mail e ferramentas Premium.",
    month: 147.9,
    year: 1477,
    href: "/contador",
    features: [
      "Tudo do PODMEI Contador",
      "Cobrança automática por e-mail (3 dias antes, no dia e 3 dias depois se não houver baixa)",
      "Assinatura personalizada nos e-mails de cobrança",
      "Remetente com o nome do escritório (Reply-To do contador)",
